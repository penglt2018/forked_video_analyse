...
where (lkj.JCH like '1004%' or lkj.JCH like '1041%' or lkj.JCH like '1128%' or lkj.JCH like '1133%' or lkj.JCH like '1153%' or lkj.JCH like '1396%' or (cast(substr(lkj.JCH, 0,4) as int) > 1495 and cast(substr(lkj.JCH, 0,4) as int) <= 1514)) and lkj.JCH != '1496B' and lkj.JCH != '1501A' and lkj.JCH != '1501B' and lkj.JCH != '1504A' and lkj.JCH != '1505A' and lkj.JCH != '1505B' and lkj.JCH != '1506B' and lkj.JICHEXINGHAO = 'HXD2' 
