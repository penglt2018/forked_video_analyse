...
def run_yolo(video_obj, video_info, lkj_file):
    ...
    if frame_mat == [] or frame_mat == [[]]:
        ...
        yolo_rt_flag = yolo_handler.exe_yolo_cellphone(frame_mat, yolo_result, video_info, fps)
        ...
        for item in files:
            ...
            if common.video_fname_check(path_file) == True:
                ...
                if video_info_rt[0] == False:
                    ...
                    print("Cellphone execute time: " + str(time.time() - s_time))                          
