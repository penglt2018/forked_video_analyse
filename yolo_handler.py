...
def store_result(final_result, video_info, mysql_db, video_obj):
    ...
    if no_break_final == []:
        ...
        if common.add_to_db(mysql_db, video_info, no_break_final, 'violate_result.report', '主司机左手未握大闸', video_obj, 'store/no_break') == False:
    ...
    if cellphone_final == []:
        ...
        if common.add_to_db(mysql_db, video_info, cellphone_move, 'violate_result.report', '玩手机(运行)', video_obj, 'store/cellphone') == False or\
            common.add_to_db(mysql_db, video_info, cellphone_stop, 'violate_result.report', '玩手机(停车)', video_obj, 'store/cellphone') == False:
    ...
    if stand_2_final == []:
        ...
        if common.add_to_db(mysql_db, video_info, stand_2_final, 'violate_result.report', '副司机进站未立岗') == False:
    ...
    if leave_1_final == []:
        ...
        if common.add_to_db(mysql_db, video_info, leave_1_final, 'violate_result.report', '主司机离岗', video_obj, 'store/leave_1') == False:
