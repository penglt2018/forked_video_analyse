                ...
                if video_info_rt[0] == False:
                    ...
                    if not os.path.isfile(lkj_file):
                        ...
                        if video_ini_flag == True:
                            ...
                            p1 = multiprocessing.Prcess(target=run_yolo,args=(video_obj, video_info, lkj_file))
                            p2=  multiprocessing.Prcess(target=run_openpose,args=(video_obj, video_info, lkj_file))
